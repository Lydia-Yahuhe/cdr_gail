...
def learn(env,
    ...
    for t in range(1, total_timesteps+1):
        ...
        print('{:>4d}'.format(env_action), end=', ')
        ...
        if t > learning_starts and t % train_freq == 0:
            ...
            if t % target_network_update_freq == 0:
                ...
                # 测试训练集和测试集
                if t % 10000 == 0 and save_path is not None:
                    env.evaluate(act, save_path=save_path + 'dqn_no_exp_evaluate_{}'.format(t))
                    env.evaluate(act, save_path=save_path + 'dqn_no_exp_test_{}'.format(t))

...
def learn(env,
    ...
    for t in range(1, total_timesteps + 1):
        ...
        num = env.scenario.id
        rew, rew_e, delta_ac = reward_giver.compare(int(num), obs, action, new_obs)
        ...
        similarity.append(int(delta_ac == 0))
        ...
        if t > learning_starts:
            ...
            p_losses.append(error)
            # Update discriminator network
            d_loss = reward_giver.update(nums, obses_t, obses_tp1)
        ...
        if done:
            ...
            if t % print_freq == 0:
                ...
                logger.record_tabular("loss", np.mean(p_losses))
